...
void main() {
  ...
  testWidgets(
    ...
    expect(wordSpans.singleWhere((span) => span.text == 'two').style?.color,
        const Color(0xFFFF0055));
    expect(wordSpans.singleWhere((span) => span.text == 'one').style?.color,
        isNot(const Color(0xFFFF0055)));
    expect(wordSpans.singleWhere((span) => span.text == 'three').style?.color,
        isNot(const Color(0xFFFF0055)));
  });
