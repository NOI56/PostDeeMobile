...
## คลังคำ ElevenLabs สำหรับการทดลอง

`ELEVENLABS_TRANSCRIPTION_KEYTERMS` ใช้เฉพาะตอนที่
`TRANSCRIPTION_PROVIDER=elevenlabs` เพื่อช่วยชื่อเฉพาะ แบรนด์ และคำขายของที่
โมเดลมักสะกดผิด ค่าเริ่มต้นเป็นค่าว่างและ Production ไม่ได้เปิดใช้

- คั่นแต่ละคำด้วยจุลภาคหรือขึ้นบรรทัดใหม่
- ระบบตัดคำซ้ำ ตรวจรูปแบบ และจำกัดไม่เกิน 100 คำก่อนเรียกผู้ให้บริการ
- รายการที่ไม่ว่างมีค่าบริการถอดเสียงของ ElevenLabs เพิ่ม 20%
- เปรียบเทียบคลิปชุดเดิมก่อนและหลังเปิดคลังคำ แล้วเก็บไว้เฉพาะคำที่ช่วยจริง
