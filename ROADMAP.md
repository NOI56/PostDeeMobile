...
8. AI Auto Editing With Configured Speech-to-Text
   ...
   - Automatic Thai subtitle cues now keep a hard one-line word cap after all merging: large text 3 words, medium 4, small 5, and karaoke 1. Mobile disables renderer wrapping, checks each cue against 85% of the scaled frame width, and shrinks only as a final overflow fallback.
